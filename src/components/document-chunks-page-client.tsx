...
import { DocumentChunksView } from "@/components/document-chunks-view";

function DocumentChunksPageInner() {
...
export function DocumentChunksPageClient() {
  return (
    <Suspense
      fallback={
